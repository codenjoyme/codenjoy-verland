...
За разминированную бомбу герой получит бонусные очки[*](index.md#ask). 
За смерть - штрафные[*](index.md#ask).
...
Итак, игрок [регистрируется на сервере](../../../register?gameName=verland), указывая свой email.

Далее необходимо подключиться из кода к серверу через websocket.
[Эта подборка](https://github.com/codenjoyme/codenjoy-clients.git)
клиентов для разных языков программирования тебе поможет в твоей игре. Как запустить клиент смотри в корне проекта в
файле README.md.
...
* Сделать шаг назад и проанализировать вокруг каких клеток точно нет бомб. 
* Выставить флажок напротив предполагаемого места с бомбой.
